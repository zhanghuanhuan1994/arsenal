...
def run_nn(sess, saver):
    ...
    model_path = os.path.join(project_root.DIR, 'Congestion_controller', 'model_IL_no_frame', 'checkpoint')
    model_name = os.path.join(project_root.DIR, 'Congestion_controller', 'model_IL_no_frame', 'model.ckpt-25')
